...
[rocco](https://github.com/zoobz-io/rocco) is an HTTP engine with built-in OpenAPI generation. Sum wraps rocco to provide the application's HTTP layer.
...
Endpoints are rocco types—see [rocco documentation](https://pkg.go.dev/github.com/zoobz-io/rocco) for handler signatures and middleware.
...
- [rocco Documentation](https://pkg.go.dev/github.com/zoobz-io/rocco)

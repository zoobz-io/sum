...
[capitan](https://github.com/zoobz-io/capitan) is an event/signal system with structured logging integration. Sum's `Event[T]` type provides a type-safe wrapper around capitan signals.
...
- [capitan Documentation](https://pkg.go.dev/github.com/zoobz-io/capitan)

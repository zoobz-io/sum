...
[grub](https://github.com/zoobz-io/grub) provides type-safe data access for SQL databases, key-value stores, and object storage. Sum's data helpers wire grub stores to the service registry and data catalog.
...
- [grub Documentation](https://pkg.go.dev/github.com/zoobz-io/grub)

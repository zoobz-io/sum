...
[fig](https://github.com/zoobz-io/fig) loads configuration from environment variables with support for secrets. Sum's `Config` helper loads configuration and registers it as a retrievable service.
...
- [capitan Integration](4.capitan.md) — Events and signals
- [fig Documentation](https://pkg.go.dev/github.com/zoobz-io/fig)
